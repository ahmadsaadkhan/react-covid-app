  ...
  //  const [country, setCountry] = useState('');
    ...
    const selectCountry = (e) => {
        ...
        if(country === 'canada'){
            ...
            const setUrl("https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/npm-covid-data/country-report-iso-based/"+url_country+'/'+url_country_short); 
        } else {
        const setUre('https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/npm-covid-data/world');
    }
    }
