                    ...
                    <div className="row">
                        ...
                        <div className="card text-white bg-danger mb-3">
                            <div className="card-body">
                                ...
                                <p className="card-text h3">{c.latest_dataTotalDeaths}</p>
                            </div>
                        </div>
                    </div>
                    <div className="col-md-3">
                        <div className="card text-white bg-success mb-3">
                            <div className="card-body">
                                ...
                                <p className="card-text h3">{c.latest_dataTotalRecovered}</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="col-md-3">
                        <div className="card text-white bg-info mb-3">
                            <div className="card-body">
                                ...
                                <p className="card-text h3">{c.latest_dataActiveCases}</p>
                            </div>
                        </div>
                    </div>
