...
const Home = () => {
        ...
        return ( < div className = "container" >
            ...
            p > An ongoing worldwide pandemic of coronavirus disease 2019(COVID - 19), a novel infectious disease caused by severe acute respiratory syndrome coronavirus 2(SARS - CoV - 2), was first confirmed to have spread to Italy on 31 January 2020, when two Chinese tourists in Rome tested positive
            for the virus. < /p> <
            /div> <
            h1 > World Data < /h1> <
            div className = "row" >
            ...
            label className = "label label-success" > Deaths 1 M population { Covid_Data && Covid_Data[0].Deaths_1M_pop } < /label> <
            /div>
