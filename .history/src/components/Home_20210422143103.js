            ...
            {Covid_Data && Covid_Data.map((c) => (
                c.name === country ? (
                    <div className="section">
                        ...
                        <div className="row">
                            <label className="label label-success">Case Fatality Rate {c.latest_data.Case_Fatality_Rate}</label>
                            <label className="label label-success">Deaths 1M population {c.latest_data.Deaths_1M_pop}</label>
                        </div>
                    </div>
                ) : ''
            ))}
