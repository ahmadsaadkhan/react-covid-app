...
const Home = () => {
    ...
    const [url, setUrl] = useState('https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/npm-covid-data/world');

    const selectCountry = (e) => {
        const country = e.target.value;
        if (country === 'canada') {
            console.log(country);
            const url_country = 'Canada';
            const url_country_short = 'can';
            const new_url = "https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/npm-covid-data/country-report-iso-based/" + url_country + '/' + url_country_short;
            setUrl(new_url);
        } else {
            const new_url = 'https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/npm-covid-data/world';
            setUrl(new_url);
        }
    }
    ...
    //     const url = 'https://vaccovid-coronavirus-vaccine-and-treatment-tracker.p.rapidapi.com/api/npm-covid-data/country-report-iso-based/Canada/can';
